...
**Note:** Tell your human partner that Superartes works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use superartes:subagent-driven-development instead of this skill.
...
4. If no concerns: Create task-list entries and proceed
...
- **REQUIRED SUB-SKILL:** Use superartes:finishing-a-development-branch
