...
# Test 8: Verify feature branch requirement
echo "Test 8: Feature branch requirement..."
...
if assert_contains "$output" "using-feature-branches\|feature.branch" "Mentions feature branch requirement"; then
    : # pass
else
    exit 1
fi
