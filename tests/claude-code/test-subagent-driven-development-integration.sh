...
# IMPORTANT: Run from superartes directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"superartes:subagent-driven-development"' "$SESSION_FILE"; then
