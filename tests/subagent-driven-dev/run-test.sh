...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superartes
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superartes-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using superartes:subagent-driven-development. The plan is at: $PLAN_PATH"
