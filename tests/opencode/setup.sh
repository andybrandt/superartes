...
mkdir -p "$HOME/.config/opencode/superartes"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/superartes/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/superartes/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/superartes/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/superartes.js" "$HOME/.config/opencode/superartes/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/superartes/.opencode/plugins/superartes.js" \
       "$HOME/.config/opencode/plugins/superartes.js"
...
echo "Plugin installed to: $HOME/.config/opencode/superartes/.opencode/plugins/superartes.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/superartes.js"
