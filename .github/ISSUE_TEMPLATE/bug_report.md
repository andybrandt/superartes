...
## Is this a Superartes issue or a platform issue?
<!-- Superartes is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Superartes installed.

     If the problem persists without Superartes, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Superartes installed
